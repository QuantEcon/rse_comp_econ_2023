...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \vspace{0.3em}
        \item some basic familiarity with computers
    \end{itemize}
...
\begin{frame}
    \frametitle{Background: Language and Platforms}
...
\begin{frame}
    ...
    \end{itemize}
            ...
            \vspace{0.5em}
            \vspace{0.5em}
    \Eg \href{https://github.com/openai}{Largest share} of OpenAI (ChatGPT) code  
